...
contract LLCHBTCPool is HBTCWrapper, IRewardDistributionRecipient {
    IERC20 public llc;
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'LLCHBTCPool: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHBTCPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHBTCPool: Cannot withdraw 0');
