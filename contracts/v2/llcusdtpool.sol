...
contract LLCUSDTPool is USDTWrapper, IRewardDistributionRecipient {
    IERC20 public llc;
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'LLCUSDTPool: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCUSDTPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCUSDTPool: Cannot withdraw 0');
        ...
        updateReward(address(0))
    {
        if (block.timestamp > starttime) {
            ...
            uint256 userReward=reward.mul(95).div(100);
            fundAmount=reward.sub(userReward);
    ...
    function contributionFund(address target,uint256 tokenAmount) public onlyOwner {
            ...
            llc.safeTransfer(address(target),tokenAmount);
    }
