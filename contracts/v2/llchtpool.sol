...
contract LLCHTPool is HTWrapper, IRewardDistributionRecipient {
    IERC20 public llc;
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'LLCHTPool: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHTPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHTPool: Cannot withdraw 0');
