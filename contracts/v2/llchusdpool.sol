...
contract LLCHUSDPool is HUSDWrapper, IRewardDistributionRecipient {
    IERC20 public llc;
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'LLCHUSD: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHUSDPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LLCHUSD: Cannot withdraw 0');
