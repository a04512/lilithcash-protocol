...
contract LlsUsdtLPTokenLlsPool is
    LPTokenWrapper,
    IRewardDistributionRecipient
{
    ...
    modifier checkStart() {
        require(
            ...
            'LlsUsdtLPTokenLlsPool: not start'
        );
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LlsUsdtLPTokenLlsPool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'LlsUsdtLPTokenLlsPool: Cannot withdraw 0');
        ...
        updateReward(address(0))
    {
        if (block.timestamp > starttime) {
            ...
            uint256 userReward=reward.mul(90).div(100);
